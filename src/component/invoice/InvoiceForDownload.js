...
const InvoiceForDownload = ({ data, user }) => {
  return (
    <>
      <Document>
        <Page size="A4" style={styles.page}>
          <View style={styles.invoiceFirst}>
            <View>
              ...
              <Text style={styles.info}>
                ...
                {data.shipping_status === "C" && (
                  <span style={{ color: "#22c55e" }}>Completed</span>
                )}
                {data.shipping_status === "R" && (
                  <span style={{ color: "#f43f5e" }}>Canceled</span>
                )}
              </Text>
            </View>
            <View>
          ...
          <View style={styles.invoiceSecond}>
            ...
            <View>
              ...
              <Text style={styles.info}>
                {" "}
                {`${data.deliver_address.house_number} ${data.deliver_address.street}`.substring(
                  0,
                  25
                )}
              </Text>
              <Text style={styles.info}>
                London Luton, United Kingdom, ${data.deliver_address.post_code}
              </Text>
            </View>
          </View>
          ...
          <View style={styles.invoiceThird}>
            <View>
              ...
              <Text style={styles.info}> Card </Text>
