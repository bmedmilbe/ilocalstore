      ...
      <div className="bg-indigo-50 p-8 rounded-t-xl">
        <div className="flex lg:flex-row md:flex-row flex-col lg:items-center justify-between pb-4 border-b border-gray-50">
          ...
          <div className="lg:text-right text-left">
            ...
            <p className="text-sm text-gray-500">
              Malanza Buy Near, LU2 7HU, Wychwood Road, <br /> Bedfordshire
              96522{" "}
            </p>
          </div>
        </div>
        <div className="flex lg:flex-row md:flex-row flex-col justify-between pt-4">
          ...
          <div className="mb-3 md:mb-0 lg:mb-0 flex flex-col">
            ...
            <span className="text-sm text-gray-500 block">#{data?.id}</span>
          </div>
          <div className="flex flex-col lg:text-right text-left">
            ...
            <span className="text-sm text-gray-500 block">
              ...
              <br />
              {data?.deliver_address.house_number}{" "}
              {data?.deliver_address.street}
              <br />
              Luton, Bedfordshire, {data?.deliver_address.post_code}
            </span>
          </div>
        </div>
      </div>
