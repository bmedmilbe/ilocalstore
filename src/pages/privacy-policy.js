        ...
        <div className="max-w-screen-2xl mx-auto lg:py-20 py-10 px-4 sm:px-10">
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                At iLocalStore, accessible from iLocalStore dot com, one of our
                ...
                and recorded by iLocalStore and how we use it. If you have
              ...
              <p>
                ...
                information that they shared and/or collect in iLocalStore.we
          ...
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                iLocalStore follows a standard procedure of using log files.
          ...
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                ...
                the advertising partners of iLocalStore. Third-party ad servers
                ...
                links that appear on iLocalStore, which are sent directly to
                ...
                that you visit. Note that iLocalStore has no access to or
          ...
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                ...
                respective advertisements and links that appear on iLocalStore,
                which are sent directly to users' browser. They automatically
                receive your IP address when this occurs. These technologies are
                used to measure the effectiveness of their advertising campaigns
                and/or to personalize the advertising content that you see on
                websites that you visit. Note that iLocalStore has no access to
                or control over these cookies that are used by third-party
                advertisers.
              </p>
              <p>
                iLocalStore's Privacy Policy does not apply to other advertisers
          ...
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              ...
              <p>
                iLocalStore does not knowingly collect any Personal Identifiable
